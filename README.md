...
SIMILITUD COSENO
Es un método que permite evaluar la similitud entre dos vectores mediante el coseno del ángulo 
entre ellos. Para hacerlo toma en consideración que		u.v = |u|.|v|. cos( ang(u,v) )
-->  u.v/ (|u|.|v|) = cos( ang(u,v) )

Cuanto más cercano a 0 sea ang(u,v), es decir menor sea la diferencia, más  cercano a 1 será su
coseno, y cuanto mas cercano a 90° sea el ángulo, mas cercano a 0 será el coseno. En el caso de 
nuestro código, llamaremos u al vector cuyos componentes son las frecuencias de los trigramas 
del texto, y v al vector que contiene las frecuencias de los trigramas del idioma. Dado que u y v
no tienen necesariamente la misma cantidad de componentes, se normaliza a cada uno por separado 
antes de realizar el producto escalar, de manera que los componentes de ambos van del 0 al 1 antes 
de hacer el producto y la cuenta termina siendo la siguiente:		(u/|u|) . (v/|v|)
